...
@AndroidEntryPoint
class RoomPersonalizationFragment : VectorBaseFragment<FragmentRoomPersonalizationBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setupToolbar(views.roomPersonalizationToolbar)
                .setTitle(im.vector.lib.strings.CommonStrings.room_profile_section_more_personalization)
                .allowBack()
