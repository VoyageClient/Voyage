...
abstract class AbsBaseMessageItem<H : AbsBaseMessageItem.Holder>(@LayoutRes layoutId: Int) :
    ...
    private fun renderReactions(holder: H, reactionsSummary: ReactionsSummaryData) {
        ReactionsContainerRenderer.render(
                ...
                hideMediaReactions = baseAttributes.informationData.hideMediaReactions,
                reactedListener = reactionClickListener,
                reactionsSummaryEvents = baseAttributes.reactionsSummaryEvents,
                longClickListener = baseAttributes.itemLongClickListener,
        )
    }
