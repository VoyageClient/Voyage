...
@Singleton
class TimelineFlickerDebugLogger @Inject constructor(context: Context) : Timber.Tree() {
    ...
    override fun log(priority: Int, tag: String?, message: String, t: Throwable?) {
        ...
        synchronized(this) {
            tryOrNull("Failed to write timeline flicker debug log") {
    ...
    private companion object {
        private const val PREFIX = "TLFDB"
        private const val FILE_NAME = "timeline-flicker.txt"
        private const val PREVIOUS_FILE_NAME = "timeline-flicker.1.txt"
