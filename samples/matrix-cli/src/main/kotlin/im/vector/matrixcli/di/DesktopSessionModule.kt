...
internal abstract class DesktopSessionModule {
    ...
    @Binds
    abstract fun bindWidgetService(service: DesktopWidgetService): WidgetService

    @Binds
    abstract fun bindWidgetUrlFormatter(formatter: DesktopWidgetURLFormatter): WidgetURLFormatter

    @Binds
    abstract fun bindIdentityService(service: DesktopIdentityService): IdentityService

    @Binds
    abstract fun bindIntegrationManagerService(service: DesktopIntegrationManagerService): IntegrationManagerService
