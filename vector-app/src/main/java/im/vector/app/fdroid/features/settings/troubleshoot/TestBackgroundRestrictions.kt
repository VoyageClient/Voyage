...
class TestBackgroundRestrictions @Inject constructor(
    ...
    override fun perform(testParameters: TestParameters) {
        context.getSystemService<ConnectivityManager>()!!.apply {
            // Checks if the device is on a metered network (isActiveNetworkMetered is API 16+).
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN && isActiveNetworkMetered) {
