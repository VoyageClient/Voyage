...
internal class AndroidComputeUserAgentUseCase @Inject constructor(
     ...
     */
    override fun execute(flavorDescription: String): String {
        ...
        val appVersion = tryOrNull { pm.getPackageInfoCompat(context.applicationContext.packageName, 0).versionName }
