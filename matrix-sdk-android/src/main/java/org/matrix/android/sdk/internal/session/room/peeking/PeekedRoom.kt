...
internal class PeekedRoom(
    ...
    private val stateService = object : StateService {
        ...
        override suspend fun updateMyRoomBanner(bannerUri: String, fileName: String) = readOnly()
        override suspend fun resetMyRoomBanner(bannerUrl: String?) = readOnly()
        override suspend fun updateMyRoomProfile(displayName: String?, avatarUrl: String?, bannerUrl: String?) = readOnly()
