...
internal class MultipleEventSendingDispatcherWorker(context: Context, params: WorkerParameters, sessionManager: SessionManager) :
        SessionSafeCoroutineWorker<MultipleEventSendingDispatcherWorkerParams>(
                context,
                params,
                sessionManager,
                MultipleEventSendingDispatcherWorkerParams::class.java
        ) {
    ...
    override fun body() = multipleEventSendingDispatcherTaskBody
}
